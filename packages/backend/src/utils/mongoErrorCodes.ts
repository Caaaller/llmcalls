...
export const MONGO_ERROR_CODES = {
  ...
  85: {
    ...
    description:
      'Index options conflict - index already exists with different options',
    isDuplicateKey: false,
  },
  ...
  86: {
    ...
    description:
      'Index key specs conflict - index already exists with different key specs',
    isDuplicateKey: false,
  },
  ...
  50: {
    ...
    description:
      'Max time MS expired - operation exceeded maximum execution time',
    isDuplicateKey: false,
  },
